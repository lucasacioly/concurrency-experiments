...
$serverPath = Join-Path $PSScriptRoot "server\server.go"  # Caminho completo para o arquivo 'server_tcp.go'
$clientPath = Join-Path $PSScriptRoot "client\client.go"  # Caminho completo para o arquivo 'client_tcp.go'
